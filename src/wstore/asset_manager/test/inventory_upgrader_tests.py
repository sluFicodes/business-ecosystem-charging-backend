...
class InventoryUpgraderTestCase(TestCase):
    ...
    _prev_asset_chars = [
        {"name": "Media Type", "value": "application/xml"},
        {"name": "Asset type", "value": "Service"},
        {"name": "Location", "value": "https://myservice.com/v1"},
    ]
    ...
    _off_bundle_chars = [
        ...
        {"name": "offering:asd Asset type", "value": "Service"},
        {
            "name": "offering:{} Location".format(_product_off_id),
            "value": "https://myservice.com/v1",
        },
        {"name": "offering:asd Media Type", "value": "application/xml"},
        {"name": "offering:{} Asset type".format(_product_off_id), "value": "Service"},
        {"name": "offering:asd Location", "value": "https://myservice.com/v1"},
    ]
    ...
    _product_bundle_chars = [
        ...
        {"name": "product:{} Asset type".format(_product_spec_id2), "value": "Service"},
        {
        ...
        {"name": "product:{} Asset type".format(_product_spec_id), "value": "Service"},
        {
    ...
    _product1["productCharacteristic"].append({"name": "speed", "value": "100mbps"})
    ...
    _product2["productCharacteristic"].append({"name": "speed", "value": "20mbps"})
    ...
    _new_asset_chars = [
        {"name": "Media Type", "value": _new_media_type},
        {"name": "Asset Type", "value": "Service"},
        {"name": "Location", "value": _new_location},
    ]

    _catalog_url = "http://localhost:8080/catalog"
    _product_spec_url = "{}/api/catalogManagement/v2/productSpecification/{}?fields=name".format(
        _catalog_url, _product_spec_id
    )
    ...
    def setUp(self):
        ...
        self._resp.json.return_value = {"name": self._product_spec_name}
    ...
    def _check_single_get_call(self):
        self._client_instance.get_products.assert_called_once_with(
            query={"productOffering.id": self._product_off_id, "fields": "id"}
        )
    ...
    def test_inventory_upgrader(self):
        ...
        self.assertEquals(
            [
                call(query={"productOffering.id": self._product_off_id, "fields": "id"}),
                call(query={"id": "1,2", "fields": "id,productCharacteristic"}),
                call(query={"id": "3,4", "fields": "id,productCharacteristic"}),
                call(query={"id": "5", "fields": "id,productCharacteristic"}),
                call(query={"productOffering.id": self._product_off_id2, "fields": "id"}),
                call(query={"id": "6", "fields": "id,productCharacteristic"}),
                call(query={"productOffering.id": self._product_off_id3, "fields": "id"}),
                call(query={"id": "7", "fields": "id,productCharacteristic"}),
                call(query={"productOffering.id": self._off_bundle_id, "fields": "id"}),
                call(query={"id": "8", "fields": "id,productCharacteristic"}),
                call(query={"productOffering.id": self._off_bundle_id2, "fields": "id"}),
                call(query={"id": "9", "fields": "id,productCharacteristic"}),
            ],
        ...
        self.assertEquals(
            [
                ...
                call("7", {"productCharacteristic": self._new_product_bundle_chars}),
        ...
        self.assertEquals(
            [
                call(
                    self._order_int,
                    self._order_int.get_product_contract(),
